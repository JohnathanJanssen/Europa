...
export const SpotlightCard: React.FC = () => {
  ...
  return (
    <div className="bg-black/60 backdrop-blur-xl border-t border-[#2d2d4d] rounded-b-2xl overflow-hidden shadow-2xl">
      <div className="flex flex-col h-[45vh] min-h-[300px] max-h-[500px] overflow-y-auto p-2 space-y-2">
        {panels.map(panel => (
          <div key={panel.id} className="bg-black/40 rounded-lg border border-gray-800/50 flex flex-col">
            <div className="flex items-center justify-between p-1.5 pr-2 bg-black/20 border-b border-gray-800/50">
